...
def generateConfidenceIntervals(replicates,K):
   ...
   print ""
   print "     i      average    bias      rms_error     stddev";
   print "-----------------------------------------------------";
   if dim == 0:
      pave = aveval
      pbias = bias
      ...
      for i in range(0,K):
         ...
         print "%7d %10.4f  %10.4f  %10.4f  %10.4f" % (i,pave,pbias,prms,pstdev)          
   elif dim==2: 
      for i in range(0,K):
         pave = aveval[0,i]
         pbias = bias[0,i]
   ...
   print "Totals: %10.4f  %10.4f  %10.4f  %10.4f" % (pave,pbias,prms,pstdev)          
